...
mean_brood <- mean(tit_dataOmit$broodSizeWhenSampled)
```
...
plot(Effect(focal.predictors = "wing",log_model), ticks=list(at=c(0.5)))

Effect(focal.predictors = "Weight",log_model)
plot(Effect(focal.predictors = c("Weight", "wing"),log_model), ticks=list(at=c(0.5)))
```
...
plot(Effect(focal.predictors = "Weight",log_model_test), ticks=list(at=c(0.5)))

Effect(focal.predictors = "wing",log_model)
plot(Effect(focal.predictors = "wing",log_model_test), ticks=list(at=c(0.5)))
